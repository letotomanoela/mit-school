...
const Page404 = ({ text, btnText, search, setVal }) => {
  return (
    <div className="flex items-center mt-6 text-center  h-96 absolute w-full">
      <div className="flex flex-col w-full max-w-sm px-4 mx-auto">
        ...
        <h1 className="mt-3 text-lg text-gray-800 dark:text-white">
          Aucun étudiant trouvés
        </h1>
        <p className="mt-2 text-gray-500 dark:text-gray-400">
          {search !== "" &&
            ` L'étudiant dont l'information possède “${search}” est introuvable. Veuillez réessayer ou ajouter un nouveau étudiant.`}
        </p>
